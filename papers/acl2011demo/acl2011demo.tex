...
\section{Metadata}%TODO Another suggestion: I think sections 3 and 5 should be merged.  Meta-data leads to plots, which can be discussed immediately rather than with a forward pointer.  The new merged section could go either before or after the current section 4 on metrics.
