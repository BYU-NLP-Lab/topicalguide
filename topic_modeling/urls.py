...
import os
from .tools import setup_logging, logging
setup_logging()
...
# AJAX Calls
    ...
    (r'^feeds/word-in-context/' + dataset + '/' + analysis + '/' + topic + '/' + word + '$',
        'word_in_context'),
	(r'^feeds/words-in-document-given-topic/' + dataset + '/' + analysis + '/' + document + '/' + topic + '$',
        'words_in_document_given_topic'),
...
# Topics
    ...
    (r'^feeds/topic-page/' + dataset + '/' + analysis + '/' + number + '$',
        'topic_page'),
    url(r'^feeds/similar-topics/' + dataset + '/' + analysis + '/' + measure + '$',
        'all_similar_topics', name='ajax-all-topics-pairwise'),
