...
function get_context_for_word(word)
{
	...
	$.getJSON(link, {}, function(word) {
		new_html = '';
		new_html += '<td class="top-words-in-context-cells top-words-doc-name"><a href="'+$.fn.topic_vars.baseurl+'/';
		new_html += $.fn.topic_vars.curtopic_number + '/documents/';
		new_html += word.doc_id;
		new_html += '">'+word.doc_name;
		new_html += '</a></td>';
		new_html += '<td class="top-words-in-context-cells right-align">';
		new_html += word.left_context;
		new_html += '</td><td class="top-words-in-context-cells word">';
		...
		new_html += '<td class="top-words-in-context-cells left-align">';
		new_html += word.right_context;
		new_html += '</td>';
		new_html += '<td id="id_new_context_';
		new_html += word.word + '" class="top-words-in-context-cells clickable_text">';
