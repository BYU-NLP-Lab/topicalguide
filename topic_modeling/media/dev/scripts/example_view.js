...
var ExampleView = DefaultView.extend({
     ...
     * 
     * Failure to use the above models may make your view hard to customize and use as a subview.
     */
    ...
    initialize: function() {
        ...
        console.log(this.self1 === this);
        console.log(this.self2 === this);
    },
...
globalViewModel.setRootViewClass(ExampleView);
