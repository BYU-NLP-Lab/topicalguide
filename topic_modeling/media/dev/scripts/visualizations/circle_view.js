...
var CircleView = DefaultView.extend({
    readableName: "Circle Diagram",
    
    visualizationTemplate:
"<div id=\"circle-view\" class=\"col-xs-9\" style=\"display: inline; float: left;\"></div>"+
"<div id=\"circle-controls\" class=\"col-xs-3 text-center\" style=\"display: inline; float: left;\"></div>",
...
"<div id=\"force-size-slider\" style=\"clear: both;\"></div>",
    ...
    render: function() {
        ...
        this.dataModel.submitQueryByHash({
            ...
            "topics": "*",
            "topic_attr": ["top_n_documents", "names"],
            "top_n_documents": 10,
        }, function(data) {
...
globalViewModel.addViewClass(["Visualizations"], CircleView);
