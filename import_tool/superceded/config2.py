...
def create_config(project):
    ...
    c['dataset_name'] = project.get_dataset_name()
    c['dataset_readable_name'] = project.get_project_name()
    c['pairwise_document_metrics'] = ['topic_correlation']
    c['num_topics'] = project.get_number_of_topics()
    c['dataset_description'] = project.get_project_description()
    c['num_iterations'] = project.get_number_of_iterations()
    c['raw_data_dir'] = project.get_project_directory()
