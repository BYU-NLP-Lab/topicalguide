 ...
 * Will set the metadataValue and/or the metadataRange values in the selectionModel.
 */
...
/**
 * Will collect the following data from the user:
 * document_seed
 * document_limit
 * document_continue
 */
var DocumentRangeSelectionWidget = DefaultView.extend({
